...
@interface SOCKSProxyOverWebsocket()
@property (nonatomic, strong) GCDAsyncSocket *listeningSocket;
@property (nonatomic) dispatch_queue_t listeningQueue;
@property (nonatomic, strong) NSMutableSet<SOCKSProxySocketOverWS*> *activeSockets;
...
@implementation SOCKSProxyOverWebsocket
...
- (void) disconnect {
    [self.activeSockets enumerateObjectsUsingBlock:^(SOCKSProxySocketOverWS *proxySocket, BOOL * _Nonnull stop) {
